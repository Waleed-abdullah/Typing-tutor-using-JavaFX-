...
public class MenuPageController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        Parent root = null;
        try {
            root = FXMLLoader.load(getClass().getResource("../Scenes/loginScreen.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    void openScoreSummary(MouseEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("../Scenes/ScoreSummary.fxml"));
        Scene typingSpeedMode = new Scene(root);
    ...
    void openRandomLettersTest(MouseEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("../Scenes/RandomLettersTest.fxml"));
        Scene typingSpeedMode = new Scene(root);
